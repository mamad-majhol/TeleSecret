...
local fuses = '!printf user#id' .. msg.from.id
 ...
 bannedidone = string.find(msg.from.id, '127144078')
        bannedidtwo =string.find(msg.from.id, '143896337')
 ...
 return 'your feedback succesfully recived to @TeleSecretBot and Team😜!'
